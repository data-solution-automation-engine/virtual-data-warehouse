...
namespace Virtual_Data_Warehouse
{
    ...
    class LoadPatternFileHandling
    {
        ...
        /// </summary>
        internal static string BackupPatternCollection(string loadPatternFilePath)
        {
            ...
            try
            {
                ...
                {
                    var targetFilePathName = loadPatternFilePath + string.Concat("Backup_" + DateTime.Now.ToString("yyyyMMddHHmmss"));
        ...
        /// <returns></returns>
        internal static string SavePatternCollection(string loadPatternFilePath, string fileContent)
        {
            string returnMessage;
        ...
        internal static List<LoadPatternFileHandling> LoadPatternCollection()
        {
            List<LoadPatternFileHandling> loadPatternList = new List<LoadPatternFileHandling>();
            ...
            {
                var jsonInput = File.ReadAllText(FormBase.VdwConfigurationSettings.LoadPatternPath + FormBase.GlobalParameters.LoadPatternListFileName);

                //Move the (json) string into a List object (a list of the type LoadPattern).
                loadPatternList = JsonConvert.DeserializeObject<List<LoadPatternFileHandling>>(jsonInput);
            }
